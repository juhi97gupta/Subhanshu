...
//public Merchant registerMerchant(Merchant merchant);
	...
	//public Merchant getMerchant(int merchantId) throws MerchantNotFoundException;
	...
	public Merchant findMerchantId(int merchantId) throws ProductNotFoundException;	
}
